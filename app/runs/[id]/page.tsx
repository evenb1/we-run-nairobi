...
export default function DynamicRunPage() {
  ...
  if (!run) {
    return (
      <div className="bg-black h-screen flex flex-col items-center justify-center font-display uppercase tracking-widest gap-4">
        <p>Run Not Found</p>
      ...
      <section className="relative h-screen w-full overflow-hidden bg-neutral-900">
        ...
        <div className="absolute bottom-12 left-0 w-full px-6 md:px-12 flex flex-col md:flex-row md:items-end justify-between gap-8">
          ...
          >
            ...
            <h1 className="text-6xl md:text-[12vw] font-display font-black leading-[0.8] uppercase italic -ml-1">
              {run.title}
            </h1>
          </motion.div>
          ...
          <motion.div 
             ...
             className="flex gap-8 md:gap-12 border-l border-white/20 pl-8 pb-4"
          >
            <div>
